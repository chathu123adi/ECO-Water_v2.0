...
//        fragmentTransaction.replace(R.id.fram,homeFragment,"Home Fragment");
//        fragmentTransaction.commit();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            FragmentTransaction fragmentTransaction= getSupportFragmentManager().beginTransaction();
            fragmentTransaction.replace(R.id.fram,fragment1,"Fragment 1");
            fragmentTransaction.commit();
        } else if (id == R.id.nav_fra2) {
            setTitle("Graph");
            Fragment2 fragment2= new Fragment2();
            FragmentTransaction fragmentTransaction= getSupportFragmentManager().beginTransaction();
            fragmentTransaction.replace(R.id.fram,fragment2,"Fragment 1");
            fragmentTransaction.commit();
        }
